...
class ConsoleLinePlayerView(ConsoleLineMessageView, PlayerView):

    @classmethod
    def prompt_to_create_or_update_player(cls, text: str, choices: list[tuple[str, str, str]]) -> str:
        """
        ask user to create or update a player
        :param text: to inform user
        :param choices: [(choice, label, value)]
        :return: user choice
        """
